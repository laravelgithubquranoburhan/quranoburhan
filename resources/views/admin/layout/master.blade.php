...
<head>
    ...
    <title>نشریه قرآن و برهان - داشبورد ادمین</title>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu animated flipInY">
                            ...
                            <li class="user-header bg-img" style="background-image: url(/admin/images/user-info.jpg)" data-overlay="3">
                                <div class="flexbox align-self-center">
                                    ...
                                    <h4 class="user-name align-self-center">
                                        <span>نشریه قرآن و برهان</span>
                                        <small>quran.burhan97@gmail.com</small>
                                    </h4>
                                </div>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                                ...
                                <div class="dropdown-divider"></div>
                                <div class="p-10"><a href="javascript:void(0)" class="btn btn-sm btn-rounded btn-success">نمایش پروفایل</a></div>
                            </li>
                        </ul>
                    </li>
                                    ...
                                    <li><!-- start message -->
                                        <a href="#">
                                            ...
                                            <div class="mail-contnet">
                                                <h4>
                                                    پنل ادمین سایت نشریه قرآن و برهان
                                                    <small><i class="fa fa-clock-o"></i> 15 mins</small>
                                                </h4>
                                                <span>نشریه قرآن و برهان, موسسه فرهنگی قرآن و عترت حکمةٌ صافیة.</span>
                                            </div>
                                        </a>
                                    </li>
                                    <!-- end message -->
