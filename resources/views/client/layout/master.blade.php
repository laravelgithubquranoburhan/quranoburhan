...
<head>
    ...
    <title>نشریه قرآن و برهان-استاد موسوی(ره)</title>
            ...
            <div class="container">
                <div class="row"> <span class="drop-icon visible-sm visible-xs"><i class="fa fa-align-justify"></i></span>
                    <div class="pull-left flip left-top">
                        <div class="links">
                            <ul>
                                <li class="mobile"><i class="fa fa-phone"></i>+21 22522995</li>
                                <li class="email"><a href="mailto:info@marketshop.com"><i class="fa fa-envelope"></i>quranburhan1397@gmail.com</a></li>
            ...
            <nav id="menu" class="navbar">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="mega-menu dropdown"><a>نشریه های چاپ شده</a>
                            <div class="dropdown-menu">
                                <div class="column col-lg-2 col-md-3"><a href="category.html">جلد اول</a>
                                    <div>
                                        <ul>
                                            <li><a href="category.html">فهرست مطالب <span>&rsaquo;</span></a>
                                                <div class="dropdown-menu">
                                                    <ul>
                                ...
                                <div class="column col-lg-2 col-md-3"> <a href="category.html">جلد دوم</a>
                                    <div>
                                        <ul>
                                ...
                                <div class="column col-lg-2 col-md-3"> <a href="category.html">جلد سوم</a>
                                    <div>
                                        <ul>
                                ...
                                <div class="column col-lg-2 col-md-3"> <a href="category.html">جلد چهارم</a>
                                    <div>
                                        <ul>
                        ...
                        <li class="menu_brands dropdown"><a href="#">انتشارات</a>
                            <div class="dropdown-menu">
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="/client/image/product/logo_all.jpg" title="اپل" alt="اپل" /></a><a href="#">موسسه</a></div>
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="/client/image/product/canon_logo-60x60.jpg" title="کنون" alt="کنون" /></a><a href="#">انتشارات</a></div>
